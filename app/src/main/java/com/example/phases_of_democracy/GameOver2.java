                ...
                FirebaseDatabase.getInstance().getReference("Users")
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            dialog = new ProgressDialog(GameOver2.this);
                            ...
                            startActivity(new Intent(GameOver2.this,PopActivity.class));

                        }
                        else
                        {

                            Toast.makeText(GameOver2.this,"Failed to Reset",Toast.LENGTH_LONG).show();
